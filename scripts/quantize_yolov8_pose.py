...
class YoloPoseDataReader(CalibrationDataReader):
    ...
    def preprocess(self, image_path):
        # YOLOv8-Pose expects RGB, 0-1 float32, (1, 3, 640, 640)
...
def export_to_onnx(model_name='yolov8s-pose.pt'):
...
def quantize_model(onnx_path, calibration_data_dir, output_dir='models'):
    ...
    dr = YoloPoseDataReader(calibration_data_dir, input_name, input_shape, size=128)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Export and quantize YOLOv8-Pose for NPU')
    parser.add_argument('--model', type=str, default='yolov8s-pose.pt', help='YOLO pose model name')
    ...
    print("\n✅ YOLOv8-Pose quantization complete!")
    print(f"   Run inference with: python inference/npu_pose_inference.py")
