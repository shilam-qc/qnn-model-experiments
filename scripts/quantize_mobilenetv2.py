...
class ImageNetDataReader(CalibrationDataReader):
    ...
    def preprocess(self, image_path):
        # MobileNetV2 expects RGB, ImageNet normalized, (1, 3, 224, 224)
...
def export_to_onnx(output_path='mobilenetv2.onnx'):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Export and quantize MobileNetV2 for NPU')
    parser.add_argument('--model', type=str, default='mobilenetv2.onnx', help='ONNX model path')
    ...
    print("\n✅ MobileNetV2 quantization complete!")
    print(f"   Run inference with: python inference/npu_classification_inference.py --model models/mobilenetv2_qdq.onnx")
